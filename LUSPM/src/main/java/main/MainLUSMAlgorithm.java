...
//        String output = ".//output_chess_3k.txt";
          String output = ".//output_SIGN_LUSPM_basic.txt" ;
...
//                System.gc();
        ...
        buffer.append("Final memory usage: " + finalMemory/(1024*1024) + " MB\n");
        buffer.append("Total memory consumed: " + (finalMemory - initialMemory)/(1024*1024) + " MB\n");
        buffer.append("Maximum memory usage: " + MemoryLogger.getInstance().getMaxMemory() + " MB\n");
        buffer.append("Output max utility: " + max_utility[0]);        buffer.append("maximum utility:"+max_utility[0]);
...
//            System.out.println(url);
            ...
            System.out.println(url);
            System.out.println("Error: URL is null (file not found)");
            return "111";
        }
    }
}